...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="anggota.css">
...
<table>
    <tr><td>Kode User</td><td>:</td><td><input type="hidden" name="id" value="<?php echo $vid; ?>" /><input type="text" name="kode_user" value="<?php echo $vkdu; ?>" /></td></tr>
